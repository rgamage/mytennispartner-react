...
namespace MyTennisPartner.Data.Utilities
{
    public static class ColorHelper
    {
        ...
        /// <summary>
        /// based on an integer seed, return a random RGB color string for use in CSS on the client to set icon colors
        /// </summary>
        /// <param name="seed"></param>
        /// <returns></returns>
        public static string GetSeededRandomColor(int seed)
        {
            const double golden_ratio_conjugate = 0.618033988749895;
            var rand = new Random(seed);
            var h = rand.NextDouble() * 360.0 + golden_ratio_conjugate * 360.0;
            var s = 0.999;
            var v = 0.75;
