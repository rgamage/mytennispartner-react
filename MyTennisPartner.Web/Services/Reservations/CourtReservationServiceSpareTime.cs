...
namespace MyTennisPartner.Web.Services.Reservations
{
    ...
    public partial class CourtReservationServiceSpareTime : ICourtReservationService
    {
        ...
        public void SetHost(string hostname)
        {
            ...
            LoginString = LoginStringTemplate.Replace("{host}", hostname, StringComparison.InvariantCulture);
            hostName = hostname;
        }
#pragma warning restore IDE1006 // Naming Styles
        ...
        private string GetCourtResourceIds(string hostname)
        {
            switch (hostname)
            {
                case "goldriver.tennisbookings.com":
                    return "1067469600|1067469601";
                case "riodeloro.tennisbookings.com":
                    return "1067471017|1067471018|1067471019|1067471020|1067471200";
                case "broadstone.tennisbookings.com":
                    return "1067471121|1067471122";
                case "lagunacreek.tennisbookings.com":
                    return "1067471158|1067471161|1067471159|1067471160";
                case "johnsonranch.tennisbookings.com":
                    return "1067471130|1067471131|1067471132|1067471133";
                case "natomas.tennisbookings.com":
                    return "1067471149|1067471150";
                case "diamondhills.tennisbookings.com":
                    return "1067471167|1067471168";
                default:
                    return "";
            }
        }
        ...
        public CourtOpeningCollection GetCourtAvailability(string username, string password, DateTime dateUtc, bool includeFutureDates = false)
        {
            ...
            // debug code only
            // File.WriteAllText("grid.html", data2);
